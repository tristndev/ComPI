...
import blogConv.EvidenceFactories.DJTStaticEvidenceFactory;
import fove.Parfactor;

public class DJTFileFactory extends AbstrDynamicFileFactory {
	...
	public DJTFileFactory(ModelWrapper mw, boolean dynamicTimesteps) {
		super(mw, "blog");
		if (dynamicTimesteps) {
			this.evidenceFactory = new DJTDynamicEvidenceFactory(mw);
		} else {
			this.evidenceFactory = new DJTStaticEvidenceFactory(mw);
		}
		this.dynamicTimesteps = dynamicTimesteps;
	}
	
	public DJTFileFactory(ModelWrapper mw, boolean dynamicTimesteps, AbstrEvidenceFactory abstrEF) {
		super(mw, "blog");
		if (dynamicTimesteps) {
			this.evidenceFactory = new DJTDynamicEvidenceFactory(mw, abstrEF);
		} else {
			this.evidenceFactory = new DJTStaticEvidenceFactory(mw, abstrEF);
		}
		this.dynamicTimesteps = dynamicTimesteps;
	}
...
//		System.out.println(str);
	...
	public void saveFile(String path) {
		...
		DJTQueryFactory qf = new DJTQueryFactory(mw, this.dynamicTimesteps, this.evidenceFactory);
		// Map = (query size, query string) pairs
